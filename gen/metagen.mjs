...
function runPremake() {
    return new Promise((resolve, reject) => {
        const premake = spawn("premake5", ["--file=gen/generate.lua"], {
            stdio: "inherit"
        });
...
(async () => {
    ...
    const data = fs.readFileSync("gen/premake_fields.json", "utf8");
    ...
    metaFieldsCombinedChunks.forEach((chunkStr, idx) => {
        ...
        fs.writeFileSync(`library/premakeFields_${idx + 1}.lua`, ignoredSpelling, "utf8");
    });
})();